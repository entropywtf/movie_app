var Movie = React.createClass({
  ...
  render() {
    var title = this.state.editable ? <input type='text' className="form-control input_title"
      ref='title' defaultValue={this.props.movie.title} /> : <h3>{this.props.movie.title}</h3>;
    var description = this.state.editable ? <input type='text'
      className="form-control input_desc" ref='description' defaultValue={this.props.
